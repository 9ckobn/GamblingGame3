...
public abstract class ClickableElement : MonoBehaviour, IClickableElement
{
    ...
    public virtual async UniTask OpenScreenAsync(UIScreen currentScreen, UIScreen nextScreen)
    {
        await currentScreen.CloseScreenWithAnimation();

        nextScreen.StartScreen();
    }

    public virtual void OpenScreen(UIScreen nextScreen)
    {
        nextScreen.StartScreen();
    }
